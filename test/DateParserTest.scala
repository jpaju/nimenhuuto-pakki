...
class DateParserTest extends munit.FunSuite:
  test("parseDate - date without year uses provided default year"):
    val actual   = DateParser.parseDate("Ti 9.12. klo 21:00", 2025)
